...
- Onnxify node type: `NegativeLogLikelihoodLossInternal`
- Since version: `1`
...
- Input options type: `NegativeLogLikelihoodLossInternalInputOptions`
- Input/output options type: `NegativeLogLikelihoodLossInternalInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.Microsoft.NegativeLogLikelihoodLossInternal(string name, NegativeLogLikelihoodLossInternalInputOptions options) -> IOnnxGraphEdge`
  - `graph.Microsoft.NegativeLogLikelihoodLossInternal(string name, NegativeLogLikelihoodLossInternalInputOutputOptions options) -> IOnnxGraphEdge`
