...
| `presence_mask` | `PresenceMask` | `IOnnxGraphEdge` | optional | Presence penalty mask. Shape is (batch_size, vocab_size) |
| `seed` | `Seed` | `IOnnxGraphEdge` | optional | Seed for random number generator. Shape is (1) |
...
| `filtered_logits` | `FilteredLogits` | `IOnnxGraphEdge` | optional | Filtered logits as input to the mutinomial function for debug purpose. Shape is (batch_size, vocab_size) |
