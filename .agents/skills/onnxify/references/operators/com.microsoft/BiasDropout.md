...
- Input options type: `BiasDropoutInputOptions`
- Input/output options type: `BiasDropoutInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.Microsoft.BiasDropout(string name, BiasDropoutInputOptions options) -> BiasDropoutOutput`
  - `graph.Microsoft.BiasDropout(string name, BiasDropoutInputOutputOptions options) -> BiasDropoutOutput`
