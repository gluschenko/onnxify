...
- Wrapper overloads detected via reflection:
  - `graph.Microsoft.QLinearAveragePool(string name, QLinearAveragePoolInputOptions options) -> IOnnxGraphEdge`
  - `graph.Microsoft.QLinearAveragePool(string name, QLinearAveragePoolInputOutputOptions options) -> IOnnxGraphEdge`
