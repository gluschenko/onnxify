...
- Input options type: `AttnLSTMInputOptions`
- Input/output options type: `AttnLSTMInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.Microsoft.AttnLSTM(string name, AttnLSTMInputOptions options) -> AttnLSTMOutput`
  - `graph.Microsoft.AttnLSTM(string name, AttnLSTMInputOutputOptions options) -> AttnLSTMOutput`
