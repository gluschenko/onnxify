...
- Input options type: `ReduceL2InputOptions`
- Input/output options type: `ReduceL2InputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.ReduceL2(string name, ReduceL2InputOptions options) -> IOnnxGraphEdge`
  - `graph.ReduceL2(string name, ReduceL2InputOutputOptions options) -> IOnnxGraphEdge`
