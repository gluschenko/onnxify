...
- Domain: `ai.onnx`
- Onnxify node type: `ReduceLogSum`
- Since version: `18`
...
- Input options type: `ReduceLogSumInputOptions`
- Input/output options type: `ReduceLogSumInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.ReduceLogSum(string name, ReduceLogSumInputOptions options) -> IOnnxGraphEdge`
  - `graph.ReduceLogSum(string name, ReduceLogSumInputOutputOptions options) -> IOnnxGraphEdge`
