...
- Wrapper overloads detected via reflection:
  - `graph.Resize(string name, ResizeInputOptions options) -> IOnnxGraphEdge`
  - `graph.Resize(string name, ResizeInputOutputOptions options) -> IOnnxGraphEdge`
...
| --- | --- |
| `ResizeTorchModuleInlineOperator` | `Resize` |