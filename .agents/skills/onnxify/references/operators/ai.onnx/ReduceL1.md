...
- Input options type: `ReduceL1InputOptions`
- Input/output options type: `ReduceL1InputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.ReduceL1(string name, ReduceL1InputOptions options) -> IOnnxGraphEdge`
  - `graph.ReduceL1(string name, ReduceL1InputOutputOptions options) -> IOnnxGraphEdge`
