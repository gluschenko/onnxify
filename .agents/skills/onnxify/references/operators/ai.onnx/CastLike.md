...
| `Onnxify.TorchSharp.TorchTensorOperatorExtensions.ExportTypeAs(this OnnxGraph graph, IOnnxGraphEdge input, IOnnxGraphEdge other) -> IOnnxGraphEdge` | `aten::type_as` |

## ModelGenerator TorchModule Coverage

| TorchModule operator | TorchSharp ops |
| --- | --- |
| `CastLikeTorchModuleInlineOperator` | `CastLike` |