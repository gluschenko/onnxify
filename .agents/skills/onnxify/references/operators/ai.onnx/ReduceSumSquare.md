...
- Domain: `ai.onnx`
- Onnxify node type: `ReduceSumSquare`
- Since version: `18`
...
- Input options type: `ReduceSumSquareInputOptions`
- Input/output options type: `ReduceSumSquareInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.ReduceSumSquare(string name, ReduceSumSquareInputOptions options) -> IOnnxGraphEdge`
  - `graph.ReduceSumSquare(string name, ReduceSumSquareInputOutputOptions options) -> IOnnxGraphEdge`
