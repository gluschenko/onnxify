...
- Domain: `ai.onnx`
- Onnxify node type: `ReduceLogSumExp`
- Since version: `18`
...
- Input options type: `ReduceLogSumExpInputOptions`
- Input/output options type: `ReduceLogSumExpInputOutputOptions`
- Wrapper overloads detected via reflection:
  - `graph.ReduceLogSumExp(string name, ReduceLogSumExpInputOptions options) -> IOnnxGraphEdge`
  - `graph.ReduceLogSumExp(string name, ReduceLogSumExpInputOutputOptions options) -> IOnnxGraphEdge`
...
| --- | --- |
| `ReduceLogSumExpTorchModuleInlineOperator` | `ReduceLogSumExp` |