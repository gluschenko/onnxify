...
| --- | --- | --- | --- | --- |
| `A` | `A` | `IOnnxGraphEdge` | single, required | Dividend tensor |
| `B` | `B` | `IOnnxGraphEdge` | single, required | Divisor tensor |

## Outputs

| JSON name | Onnxify property | Type | Semantics | Description |
| --- | --- | --- | --- | --- |
| `C` | `C` | `IOnnxGraphEdge` | single, required | Remainder tensor |
