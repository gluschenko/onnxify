...
- When documenting package baselines, keep README and skill wording aligned: core `Onnxify` currently uses standard ONNX opset 25 and IR version 11 by default, and `Onnxify.TorchSharp` currently references `TorchSharp` `0.107.0`.
