...
namespace Onnxify
{
    ...
    internal static class OnnxUtils
    {
        ...
        {
            ArgumentException.ThrowIfNullOrEmpty(opType, nameof(opType));
        ...
        private static TensorProto.Types.DataType ConvertToTensorProtoType(Type rawType)
        {
            ...
            {
                string message = "Unsupported type: " + rawType.ToString();
        ...
        )
        {
            ...
            ArgumentNullException.ThrowIfNull(inputs, nameof(inputs));
            ArgumentNullException.ThrowIfNull(outputs, nameof(outputs));
            ArgumentNullException.ThrowIfNull(intermediateValues, nameof(intermediateValues));
            ArgumentNullException.ThrowIfNull(initializers, nameof(initializers));
            ArgumentException.ThrowIfNullOrEmpty(producerName, nameof(producerName));
            ArgumentException.ThrowIfNullOrEmpty(name, nameof(name));
            ArgumentException.ThrowIfNullOrEmpty(domain, nameof(domain));
            ArgumentException.ThrowIfNullOrEmpty(producerVersion, nameof(producerVersion));
            ...
            var model = new ModelProto
            {
                ...
                IrVersion = (long)Version.IrVersion,
        ...
        /*public static ModelArgs GetModelArgs(
            ...
            string colName,
            List<long>? dims = null,
            List<bool>? dimsParams = null
        )
        {
            ArgumentNullException.ThrowIfNull(type, nameof(type));
            ArgumentException.ThrowIfNullOrEmpty(colName, nameof(colName));
