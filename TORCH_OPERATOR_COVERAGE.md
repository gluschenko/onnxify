...
| `aten::_embedding_bag_forward_only` |  | ❌ | ❌ | ❌ | ❌ | ❌ | 7 |
| `aten::_fft_c2c` |  | ❌ | ❌ | ❌ | ❌ | ❌ | 0 |
| `aten::_fft_c2r` |  | ❌ | ❌ | ❌ | ❌ | ❌ | 0 |
| `aten::_fft_r2c` |  | ❌ | ❌ | ❌ | ❌ | ❌ | 0 |
...
| `aten::is_nonzero` | `TorchSharp.torch+Tensor.is_nonzero` | ✅ | ✅ | ❌ | ✅ | ❌ | 9 |
...
| `aten::scatter.value` | `TorchSharp.torch+Tensor.scatter` | ✅ | ❌ | ❌ | ❌ | ❌ | 20 |
